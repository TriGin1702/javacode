...
import projectjava.BLL.BLLkhachhang;
...
public class khachhangdata extends JFrame implements ActionListener {
	private static final long serialVersionUID = 1L;
	JFrame f,f1,f2,f3;
	BLLkhachhang bll = new BLLkhachhang();
    DefaultTableModel model1 = new DefaultTableModel();
    Vector <khachhang> k = new Vector<khachhang>();
    ...
    khachhangdata(){
        ...
        tf1.setColumns(10);
        f = new JFrame("bảng khách hàng");
        f1 = new JFrame("Thêm Khách hàng");
        f2 = new JFrame("tìm kiếm Khách hàng");
        ...
        k = bll.getAllkhachhangs();
        for (int i = 0; i < k.size(); i++) {
        	khachhang s = k.get(i);
        	model1.addRow(new Object[] {
        			s.getmakh(),s.getHoten(),s.getemail(),s.getsdt()
        	});
        }
        f.setSize(900,540);
        f1.setSize(700,250);
...
//        t4.setHorizontalAlignment(JTextField.CENTER);
        ...
        JLabel l3 = new JLabel("mã khách hàng ");
        ...
        JLabel l13 = new JLabel("mã khách hàng ");
        ...
        JLabel l8 = new JLabel("Mã khách hàng:: ");
        ...
        p = new JPanel();
        JLabel l = new JLabel("Khách hàng");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (e.getSource() == b7){
        	if (t1.getText().trim().equals("")||t2.getText().trim().equals("")||t3.getText().trim().equals("")||tf.getValue() == null) {
        		...
        		k.add(new khachhang(t1.getText(),t2.getText(),t3.getText(),tf.getValue().toString()));
        		int i = k.size()-1;
        		khachhang s = k.get(i);
        		model1.addRow(new Object[]{
        				s.getmakh(),s.getHoten(),s.getemail(),s.getsdt()
...
//            f1.dispose();
        ...
        if (e.getSource() == b8){
            ...
            for(i =0; i<k.size();i++){
                khachhang s = k.get(i);
                if ((t5.getText().matches(s.getmakh())||t5.getText().matches(""))&&(t6.getText().matches(s.getHoten())||t6.getText().matches("")) && (t7.getText().matches(String.valueOf(s.getemail()))||t7.getText().matches(""))&&(t8.getText().matches(s.getsdt())||t8.getText().matches("") )){
        ...
        if(e.getSource() == b3){
            ...
            if (i>-1){
                model2.insertRow(0,new Object[]{
                    a.getmakh(),a.getHoten(),a.getemail(),a.getsdt()
                });;
        ...
        if(e.getSource() == b5){
            int i = jTable1.getSelectedRow();
            khachhang b = k.get(i);
            t9.setText(b.getmakh());t10.setText(b.getHoten());t11.setText(b.getemail());tf1.setValue(b.getsdt());
        	f3.setVisible(true);
        }
        if(e.getSource()== b9) {
        	int i = jTable1.getSelectedRow();
        	khachhang b= new khachhang();
        	b.setmakh(t9.getText());b.setHoten(t10.getText());b.setemail(t11.getText());b.setsdt(tf1.getValue().toString());
        	if(b.getmakh().matches(k.get(i).getmakh()) == false && b.getsdt().matches(k.get(i).getsdt()) == false){
        		JOptionPane.showMessageDialog(f3,"không thể sửa makh và sdt cùng lúc");
        	}
        	else {
        		model1.insertRow(i, new Object[] {
            			b.getmakh(),b.getHoten(),b.getemail(),b.getsdt()
            	});
        		model1.removeRow(i+1);
        		k.set(i, b);
        		bll.updatekhachhang(b);
        		bll.updatekhachhang2(b);
        	}
        }
        if(e.getSource()==b6){
            f.dispose();
